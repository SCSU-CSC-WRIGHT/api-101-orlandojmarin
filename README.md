...
1. **Copy all `.py` files from `proj1` to `proj2` (keeping file names unchanged):** <br>cp -piv /home/activity2/proj1/*.py /home/activity2/proj2/
2. **Copy all `.py` files from `proj1` to the top-level directory (keeping file names unchanged):** <br>cp -piv /home/activity2/proj1/*.py /home/activity2/
3. **Copy `p1.txt` from `proj1` to `proj2` as `p1_new.txt` (from top-level directory):** <br>cp -piv /home/activity2/proj1/p1.txt /home/activity2/proj2/p1_new.txt
4. **Create a subdirectory `proj3` under the top-level directory and copy all contents of `proj1` to it:** <br>mkdir -v /home/activity2/proj3 <br>cp -rpiv /home/activity2/proj1/ /home/activity2/proj3/
